 ...
 *
 * Written the way the vendor agreement is written: plain sentences, the
 * unfavourable parts stated rather than buried, and the sections that decide
 * money or obligation marked conspicuous so they are visually impossible to
 * skim past.
 *
 * The point of view matters. This is not a donation and the terms should not
 * read like one. The organization is being paid for services at an event, and
 * every clause that follows from that, the forfeit, the waivers, the fact that
 * Coyoteville counts the cars, is easier to accept when the arrangement is
 * named honestly at the top.
 */
...
export const FNF_TERMS_VERSION = TERMS_VERSION;

export const FNF_TERMS: TermsBlock[] = [
  {
    kind: 'paragraph',
  ...
  { kind: 'heading', text: '1. What your organization agrees to do' },
  {
    kind: 'paragraph',
  ...
  },
  {
    kind: 'list',
    items: [
      `Bring at least ${VOLUNTEER_MINIMUM} adults, aged 18 or over, for the whole shift.`,
  ...
  { kind: 'heading', text: '2. Volunteers, adults and anyone under 18' },
  {
    kind: 'paragraph',
  ...
  {
    kind: 'conspicuous',
    text: `ANYONE UNDER 18 MAY HELP ONLY WITH A PARENT OR GUARDIAN PRESENT ON SITE FOR THE WHOLE SHIFT, AND MAY NOT DIRECT TRAFFIC OR STAND IN A TRAFFIC LANE AT ANY TIME. MINORS DO NOT COUNT TOWARD THE ${VOLUNTEER_MINIMUM} ADULT MINIMUM.`,
  },

  { kind: 'heading', text: '3. What your organization is paid' },
  {
    kind: 'paragraph',
    text: `Your organization receives 50 percent of the gross parking revenue for that game. Gross means every vehicle counted at the gate at $${(PARKING_PRICE_CENTS / 100).toFixed(0)} per vehicle, before any expense of any kind is taken out. Nothing is deducted before the split.`,
  },
  {
    kind: 'paragraph',
    text: `Coyoteville counts the vehicles and determines the parking revenue for the game. That figure is published on the ${PROGRAM_NAME} page alongside your organization's name and the amount paid, so the arithmetic is visible to anyone who wants to check it.`,
  },
  {
    kind: 'paragraph',
    text: `Payment is made within ${PAYOUT_WINDOW_DAYS} days of the game, by check or by whatever method the two of us agree.`,
  },

  { kind: 'heading', text: '4. If your organization does not turn up' },
  {
    kind: 'conspicuous',
    text: `IF YOUR ORGANIZATION DOES NOT ARRIVE WITH AT LEAST ${VOLUNTEER_MINIMUM} ADULTS AT THE AGREED TIME, IT FORFEITS ITS SHARE FOR THAT GAME IN FULL. COYOTEVILLE WILL STILL RUN PARKING AND WILL OWE YOUR ORGANIZATION NOTHING FOR THAT NIGHT.`,
  },
  {
    kind: 'paragraph',
  ...
  { kind: 'heading', text: '5. How organizations are selected' },
  {
    kind: 'paragraph',
  ...
  { kind: 'heading', text: '6. Insurance, conduct and liability' },
  {
    kind: 'paragraph',
  ...
  {
    kind: 'paragraph',
    text: `Coyoteville may ask any individual to stop working the event at any time, for any reason. If that leaves your organization below ${VOLUNTEER_MINIMUM} adults, the forfeit in Section 4 does not apply.`,
  },

  { kind: 'heading', text: '7. Weather and cancellation' },
  {
    kind: 'paragraph',
